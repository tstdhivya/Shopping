 ...
 * inheritance. (So in this case, it will NOT get a save() method.) Note that
 * the methods declared here and in child repositories must exactly match the
 * method signatures defined in JpaRepository, CrudRepository and
